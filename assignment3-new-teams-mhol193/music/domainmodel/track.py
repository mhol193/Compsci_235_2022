...
class Track:
    def __init__(self, track_id: int, track_title: str):
        ...
        self.__track_img_url: str | None = None
        # duration in seconds
    ...
    @track_img_url.setter
    def track_img_url(self, new_img_url: str):
        if type(new_img_url) is str:
            self.__track_img_url = new_img_url.strip()
        else:
            self.__track_img_url = None
